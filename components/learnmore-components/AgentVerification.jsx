        ...
        >
          ...
          <AnimateOnScroll from="left">
            ...
            >
              ...
              <span style={{ color: "#A78BFA" }}>Trust The Network.</span>
            </h2>
            <p style={{ color: "var(--text-body)", fontSize: "15px", lineHeight: 1.75, marginBottom: "28px" }}>
              ...
              automated agents. An odd number (five, seven, or nine) independently verify
              ...
              {properties.map((p) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "13px", color: "var(--text-muted)", lineHeight: 1.6 }}>{p.detail}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            >
              ...
              >
                {agentVotes.map((vote, i) => (
                  ...
                  >
                    <p style={{ fontSize: "10px", fontFamily: "monospace", color: "var(--text-faint)" }}>
                      A{i + 1}
                    </p>
                    <p
                      style={{
              ...
              >
                <p style={{ fontSize: "11px", color: "var(--text-faint)", fontFamily: "monospace" }}>
                  majority vote
                </p>
